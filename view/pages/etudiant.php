...
<div class="row">
    <div class="col-lg-12 col-xlg-12 col-md-12 col-sm-12 col-xs-12 content1 bg-light  mx-auto d-block mt-2 border border-info">    
        ...
        <div class="row">
          <div class="col-9">
            <a name="rechercher" id="rechercher" class="btn btn-secondary col-lg-2 col-xlg-2 col-md-2 col-sm-3 col-xs-3 float-left text-decoration-none ml-3 mb-3" href="#" role="button">Rechercher</a>
            <input type="text" class="form-control col-lg-6 ml-3" name="recherche" id="recherche" placeholder="Saisissez votre option de recherche">
          </div>
          <div class="col-3">
              <a name="nouveau" id="nouveau" class=" btn btn-secondary col-lg-6 col-xlg-6 col-md-7 col-sm-9 col-xs-3 text-decoration-none" href="#" role="button">Nouveau</a>
          </div>
        </div>
